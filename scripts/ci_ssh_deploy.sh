...
$SSH_CMD "cp $DEPLOY_PATH/stokr-lite/backend/target/stokr-lite.jar /opt/stokr/stokr-lite.jar && echo 'JAR copied OK'"
echo ""
...
$SSH_CMD "rm -rf /opt/stokr/ui/* && cp -r $DEPLOY_PATH/stokr-lite/frontend/dist/* /opt/stokr/ui/ && chmod -R 755 /opt/stokr/ui/assets/ && echo 'Frontend deployed OK'"
echo ""
