import paramiko;s=paramiko.SSHClient();s.set_missing_host_key_policy(paramiko.AutoAddPolicy());s.connect('173.249.55.84',username='root',password='19119e3a6793dde1',timeout=10)
