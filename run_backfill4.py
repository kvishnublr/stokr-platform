...
# Write the script content as a heredoc via SSH
script_content = '''import json, subprocess, time, os
...
# Write to local file
local_path = r"C:\Users\itsvi\Desktop\work_new\stokr-platform\backfill_final.py"
with open(local_path, "w", encoding="utf-8") as f:
    f.write(script_content)

# SCP to server
os.system('scp -o StrictHostKeyChecking=no "' + local_path + '" root@173.249.55.84:/tmp/backfill_final.py')
