  ...
  return (
    <div className="space-y-5">
      ...
      <TableShell tab="ratio" count={opps.length} headerContent={
        ...
        {opps.map((o, i) => (
          <tr key={i} className={`hover:bg-violet-50/40 transition-colors ${i === 0 ? 'bg-violet-50/20' : ''}`}>
  ...
  return (
    <div className="space-y-5">
      ...
      <TableShell tab="bwb" count={opps.length} headerContent={
        ...
        {opps.map((o, i) => (
          <tr key={i} className={`hover:bg-amber-50/40 transition-colors ${i === 0 ? 'bg-amber-50/20' : ''}`}>
            <td className="px-4 py-3 font-bold text-slate-800">{o.underlying}</td>
            <td className="px-4 py-3"><TypeBadge type={o.optionType} /></td>
  ...
  return (
    <div className="space-y-5">
      ...
      <TableShell tab="skew" count={opps.length} headerContent={
        ...
        {opps.map((o, i) => (
          <tr key={i} className={`hover:bg-cyan-50/40 transition-colors ${i === 0 ? 'bg-cyan-50/20' : ''}`}>
            <td className="px-4 py-3 font-bold text-slate-800">{o.underlying}</td>
  ...
  return (
    <div className="space-y-5">
      ...
      <TableShell tab="theta" count={opps.length} headerContent={
        ...
        {opps.map((o, i) => (
          <tr key={i} className={`hover:bg-emerald-50/40 transition-colors ${o.isOptimalWindow ? 'bg-emerald-50/20' : ''}`}>
            <td className="px-4 py-3 font-bold text-slate-800">{o.underlying}</td>
