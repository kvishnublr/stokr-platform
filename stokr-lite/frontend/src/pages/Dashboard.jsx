  ...
  return (
    <div>
      <div className="mb-8 animate-fade-in-up">
        ...
        <p className="text-slate-400 text-sm ml-4">Overview of your trading activity</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Active Deployments */}
        <div className="lg:col-span-2 card-crystal">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <h2 className="font-semibold text-slate-800 text-sm">Active Deployments</h2>
        ...
        <div className="card-crystal">
          <div className="px-5 py-4 border-b border-slate-100">
            <h2 className="font-semibold text-slate-800 text-sm">Market Status</h2>
          </div>
          <div className="p-5">
            <MarketStatus />
...
function StatCard({ title, value, icon, gradient }) {
  return (
    <div className="card-crystal p-5 flex items-start justify-between hover-lift">
      <div>
...
function ModeBadge({ mode }) {
  return mode === 'LIVE'
    ? <span className="px-2 py-1 rounded-full text-xs font-semibold bg-rose-50 text-rose-600 border border-rose-200">LIVE</span>
    : <span className="px-2 py-1 rounded-full text-xs font-semibold bg-amber-50 text-amber-600 border border-amber-200">PAPER</span>;
}
