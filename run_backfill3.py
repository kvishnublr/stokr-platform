...
# Write backfill script to local file
lines = [
...
with open(r"C:\Users\itsvi\Desktop\work_new\stokr-platform\backfill_z.py", "w", encoding="utf-8") as f:
    f.write('\n'.join(lines))

os.system('scp -o StrictHostKeyChecking=no "C:\\Users\\itsvi\\Desktop\\work_new\\stokr-platform\\backfill_z.py" root@173.249.55.84:/tmp/backfill_z.py')
print("Running backfill...")
result = remote("python3 /tmp/backfill_z.py 2>&1")
print(result[-2000:])
