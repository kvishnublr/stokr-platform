...
print(remote("PGPASSWORD=`$POSTGRES_PASSWORD psql -h localhost -U postgres -d stokr_lite -c \"SELECT timestamp::date as day, count(*) as symbols FROM candle_data WHERE timeframe='daily' AND timestamp >= '2026-07-01' GROUP BY day ORDER BY day;\""))
